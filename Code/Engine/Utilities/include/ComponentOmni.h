...
public:
  ...
  static CComponentOmni* AddToEntity(CGameEntity* _pEntity, Vect3f& _vOffsetPosition, const CColor& _vColor, float _fStartRangeAtt, float _fEndRangeAtt);
...
protected:
  ...
  bool Init(CGameEntity* _pEntity, Vect3f& _vOffsetPosition, const CColor& _vColor, float _fStartRangeAtt, float _fEndRangeAtt);
